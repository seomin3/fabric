...
:<<END
# package install
install_pkgs 'openstack-nova-compute iproute tcpdump'
...
install_pkgs 'openstack-neutron-ml2 openstack-neutron-openvswitch tcpdump'
...
for i in neutron-{dhcp,metadata,openvswitch,l3}-agent
do
    service_handle $i
done
